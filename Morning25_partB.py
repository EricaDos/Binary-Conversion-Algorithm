...
letter = ""
#<---------------------------------------------------------------------------------------------------------------------------------------------------------->
# these are variable used in the code below letter refers to an empty string.
#<---------------------------------------------------------------------------------------------------------------------------------------------------------->
while floating_number > 0:
  ...
  # and then rounding that to 3 places to avoid prevent rounding mistakes later on.
  # <---------------------------------------------------------------------------------------------------------------------------------------------------------->
